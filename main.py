...
if __name__ == '__main__':
    ...
    #         print(
    #             f"Total changed files in the commit: {sum(files_extension_dict.values())}")
    # else:
    ...
    git_utils.fetch_consecutime_time_between_commits(repository_owner, repository_name, access_token, "sohmpatil")
